...
import { getPosts, upVoteCreator, downVoteCreator } from './actionCreators';
...
function BlogList() {
    ...
    postsArr.sort((a, b) => (a.votes < b.votes) ? 1 : -1)
